...
Dieses Verzeichnis enthält die Anleitungen, Prozessbeschreibungen und Hintergrundinformationen für die GitHub-basierte Aufgaben- und Sitzungsverwaltung des DACH-Teams. Themen werden als Sitzungs-Issues geführt, Beschlüsse als Protokoll im selben Issue, daraus entstehende Aufgaben als eigene Issues im Aufgaben-Board.
...
```text
        ...
        ┌───────────────────┼───────────────────┐
        │                   │                   │
thema-vorschlagen   aufgabe-erfassen   sitzung-durchfuehren
        │                   │                   │
        └─────────► aufgaben-board ◄────────────┘
                            ▲
                            │
